...
public class MyClientV2 {
    ...
    private static serverdata[] servers; // stores the hardware information of all the servers as sent by ds-server
    private static List<serverdata> largestServers = new ArrayList<serverdata>(); // a list of all servers of the
                                                                                  // largest type
    ...
    private static void scheduleJobFc(BufferedReader in, DataOutputStream out) {
        try {
            ...
            serverdata capableInfo = getServersData(in, out, "capable")[0];
    ...
    private static ArrayList<serverdata> getLargestServers() {
        int largestIndex = 0;
        ...
        ArrayList<serverdata> largest = new ArrayList<serverdata>();
